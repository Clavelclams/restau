    ...
    <div class="container-fluid">
        <div class="row">
            <header class="fixed-top d-flex">
                <nav class="navbar navbar-expand-lg bg-transparent col-12">
                    <a class="navbar-brand me-auto" href="#"><img src="asset/img/logo-bg.png" alt=""></a>
